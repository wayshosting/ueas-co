...
Copyright (C) 2013  Stefania Marchisio (email: stefonthenet@gmail.com)
...
?>
	...
	// Topic options in Google News on 29 Dec 2012
...
function rssjb_List($feed, $filter, $num, $ltime, $list, $target, $pubdate, $pubtime, $dformat, $tformat, $pubauthor, $excerpt, $charex, $chartle, $sort, $cachefeed) {
	...
	if ( filter_var($pubauthor, FILTER_VALIDATE_BOOLEAN) ) {
		...
		$flist .= '<p style="text-align:right; font-size: 0.8em">powered by <a target="_blank" href="http://www.iso.org/iso/home/news_index.htm/">ISO</a> News</p>';
