...
class MDShortcodes {
    ...
    {	//echo get_template_directory_uri(__FILE__);
    	define('ZILLA_TINYMCE_URI', get_template_directory_uri().'/functions/extended/md-shortcodes/tinymce');
		define('ZILLA_TINYMCE_DIR', get_template_directory_uri().'/functions/extended/md-shortcodes/tinymce');
	...
	{
		$plugin_array['zillaShortcodes'] = get_template_directory_uri().'/functions/extended/md-shortcodes/tinymce/plugin.js';
		return $plugin_array;
	}
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => get_template_directory_uri() .'/functions/extended/md-shortcodes') );
	}
    
}
$zilla_shortcodes = new MDShortcodes();
